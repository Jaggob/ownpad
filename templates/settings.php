...
<div class="section" id="ownpad-sync-settings">
	...
	<p><?php p($l->t('Synchronizes pad content when you open the pad, while it stays open, and once more when you close it.')); ?></p>
	<div class="field">
		<input type="checkbox" id="ownpad-sync-enabled">
		<label for="ownpad-sync-enabled"><?php p($l->t('Sync pad content into file (indexable)')); ?></label>
	</div>
	<div class="field">
